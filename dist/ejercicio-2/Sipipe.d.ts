export declare class SiPipe {
    constructor();
    contarLineas(fichero: string): void;
    contarPalabras(fichero: string): void;
    contarCaracteres(fichero: string): void;
    contarTodo(fichero: string): void;
}
/**
